...
from hashes.dejavu.dejavu.base_classes.base_database import get_database
from hashes.dejavu.dejavu.config.settings import (DEFAULT_FS, DEFAULT_OVERLAP_RATIO,
...
from hashes.dejavu.dejavu.logic.fingerprint import fingerprint
